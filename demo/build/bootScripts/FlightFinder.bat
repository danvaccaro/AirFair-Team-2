...
set JARPATH=%APP_HOME%\lib\FlightFinder-0.0.1-SNAPSHOT.jar

@rem Execute FlightFinder
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FLIGHT_FINDER_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%FLIGHT_FINDER_EXIT_CONSOLE%" exit 1
exit /b 1
